...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white h-screen sticky top-0 flex flex-col shrink-0">
      ...
      <div className="p-4 border-t border-gray-800 shrink-0">
        <button
          ...
          className="flex items-center gap-3 px-4 py-2.5 w-full text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition"
        >
