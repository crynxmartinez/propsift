    ...
    <div className="p-6 max-w-4xl mx-auto">
          ...
          <div className="flex-1 min-w-0">
            {isEditing ? (
              ...
              <>
                ...
                <p className="text-gray-700 mt-4 whitespace-pre-wrap">{post.description}</p>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        {post.comments.length > 0 ? (
            ...
            {post.comments.map((comment) => (
              <div
                ...
                className={`p-4 rounded-lg ${
                  comment.isAdminReply ? 'bg-blue-50 border border-blue-100' : 'bg-gray-50'
                }`}
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-2">
          ...
          <p className="text-gray-500 text-center py-6 mb-6">No comments yet. Be the first to comment!</p>
        )}
